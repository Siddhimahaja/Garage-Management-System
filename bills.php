...
<html>
  ...
  <body  class="bg">
    <div class='container pt-5'>
      <h1 class='text-center text-primary'>BILLS</h1><hr>
	  <hr style="height:2px;border-width:1px;color:#24ff2b;background-color:rgb(27, 245, 34);">
      <?php
      ...
      ?>
      <form method='post' action='bills.php' autocomplete='off' style="color:white;">
        <div class='row'>
          <div class='col-md-4'>
